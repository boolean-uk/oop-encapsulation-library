...
describe('Library', () => {
    ...
    it('should be able to add a book to the collection', () => {
        library.addBook('A Game of Thrones', 'George R. R. Martin', 75, 'georgemartin@gmail.com', 'Fantasy', 'August 1, 1996', 'Simon & Schuster', 'https://www.simonandschuster.com/')
    ...
    it('should be able to remove an book from the collection', () => {
        library.addBook('A Game of Thrones', 'George R. R. Martin', 75, 'georgemartin@gmail.com', 'Fantasy', 'August 1, 1996', 'Simon & Schuster', 'https://www.simonandschuster.com/')
        library.addBook("Harry Potter and the Philosopher's Stone", 'J. K. Rowling', 58, 'jkrowling@gmail.com', 'Fantasy', 'June 26, 1997', 'Bloomsbury', 'https://www.bloomsbury.com/uk/')
    ...
    it("should be only able to modify book's genre", () => {
        library.addBook('A Game of Thrones', 'George R. R. Martin', 75, 'georgemartin@gmail.com', 'Drama', 'August 1, 1996', 'Simon & Schuster', 'https://www.simonandschuster.com/')
    ...
    it("should throw an error if the book's title, author, genre or release not provided correctly", () => {
        expect(() => library.addBook('A Game of Thrones', 'George R. R. Martin', 75, 'georgemartin@gmail.com', 'Fantasy', 1996, 'Simon & Schuster', 'https://www.simonandschuster.com/')).toThrowError("Book's properties should be provided correctly")
    }) 
